...
enum class Msr : unsigned int {
	...
	kIa32Debugctl = 0x1D9,
	kIa32VmxBasic = 0x480,			//Is support VMX?
	kIa32VmxPinbasedCtls = 0x481,			//how to set Pin-based Vm-execution field's 1, 2, 4 bit
	kIa32VmxProcBasedCtls = 0x482,		//how to set Processor-based Vm-execution field's 1, 4-6, 8, 13-16, 26bit
	kIa32VmxExitCtls = 0x483,
	kIa32VmxEntryCtls = 0x484,
	kIa32VmxMisc = 0x485,
	kIa32VmxCr0Fixed0 = 0x486,			//ask for fixed CR0's bit to be 0
	kIa32VmxCr0Fixed1 = 0x487,			//ask for fixed CR0's bit to be 1
	kIa32VmxCr4Fixed0 = 0x488,			//same
	kIa32VmxCr4Fixed1 = 0x489,			//same
	kIa32VmxVmcsEnum = 0x48A,
	kIa32VmxProcBasedCtls2 = 0x48B,
	kIa32VmxEptVpidCap = 0x48C,
	kIa32VmxTruePinbasedCtls = 0x48D,		//how to set Pin-based Vm-execution field reserved bits
	kIa32VmxTrueProcBasedCtls = 0x48E,            //how to set Processor-based Vm-execution reserved bits
...
#define VMX_PIN_BASED_EXTERNAL_INTERRUPT_VMEXIT   (1 << 0)
#define VMX_PIN_BASED_NMI_EXITING                 (1 << 3) 
#define VMX_PIN_BASED_VIRTUAL_NMI                 (1 << 5)  
#define VMX_PIN_BASED_VMX_PREEMPTION_TIMER_VMEXIT (1 << 6)  
#define VMX_PIN_BASED_PROCESS_POSTED_INTERRUPTS   (1 << 7)  
...
#define VMX_PRCESSOR_BASED_INTERRUPT_WINDOW_VMEXIT   (1 << 2)
#define VMX_PRCESSOR_BASED_TSC_OFFSET                (1 << 3)
#define VMX_PRCESSOR_BASED_HLT_VMEXIT                (1 << 7)
#define VMX_PRCESSOR_BASED_INVLPG_VMEXIT             (1 << 9)
#define VMX_PRCESSOR_BASED_MWAIT_VMEXIT              (1 << 10)
#define VMX_PRCESSOR_BASED_RDPMC_VMEXIT              (1 << 11)
#define VMX_PRCESSOR_BASED_RDTSC_VMEXIT              (1 << 12)
#define VMX_PRCESSOR_BASED_CR3_WRITE_VMEXIT          (1 << 15) /* legacy must be '1 */
#define VMX_PRCESSOR_BASED_CR3_READ_VMEXIT           (1 << 16) /* legacy must be '1 */
#define VMX_PRCESSOR_BASED_CR8_WRITE_VMEXIT          (1 << 19) /* TPR shadow */
#define VMX_PRCESSOR_BASED_CR8_READ_VMEXIT           (1 << 20) /* TPR shadow */
#define VMX_PRCESSOR_BASED_TPR_SHADOW                (1 << 21) /* TPR shadow */
#define VMX_PRCESSOR_BASED_NMI_WINDOW_EXITING        (1 << 22) /* Virtual NMI */
#define VMX_PRCESSOR_BASED_DRx_ACCESS_VMEXIT         (1 << 23)
#define VMX_PRCESSOR_BASED_IO_VMEXIT                 (1 << 24)
#define VMX_PRCESSOR_BASED_IO_BITMAPS                (1 << 25)
#define VMX_PRCESSOR_BASED_MONITOR_TRAP_FLAG         (1 << 27) /* Monitor Trap Flag */
#define VMX_PRCESSOR_BASED_MSR_BITMAPS               (1 << 28)
#define VMX_PRCESSOR_BASED_MONITOR_VMEXIT            (1 << 29)
#define VMX_PRCESSOR_BASED_PAUSE_VMEXIT              (1 << 30)
#define VMX_PRCESSOR_BASED_SECONDARY_CONTROLS        (1 << 31)
...
enum class InvEptType : ULONG_PTR {
	kSingleContextInvalidation = 1,		//指定EPTP?置為無效
	kGlobalInvalidation = 2,				//全部EPTP?置為無效
};
